//
//  ZPRecommendPageViewController.m
//  PlayDemo
//
...
@interface ZPRecommendPageViewController ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)handleSingleTap:(UIGestureRecognizer *)gestureRecognizer
{
    ...
    ZPChannelInfo *selectChannel;
    ZPVideoInfo *selectVideo;
    switch (eventImageView.tag) {
        case 100:
            selectChannel = [self.channelsInfos firstObject];
            selectVideo = [selectChannel.video_list firstObject];
            break;
        case 200:
            selectChannel = self.channelsInfos[1];
            selectVideo = selectChannel.video_list[0];
            break;
        case 210:
            selectChannel = self.channelsInfos[1];
            selectVideo = selectChannel.video_list[1];
            break;
        case 220:
            selectChannel = self.channelsInfos[1];
            selectVideo = selectChannel.video_list[2];
            break;
        case 230:
            selectChannel = self.channelsInfos[1];
            selectVideo = selectChannel.video_list[3];
            break;
        case 300:
            selectChannel = self.channelsInfos[2];
            selectVideo = selectChannel.video_list[0];
            break;
        case 310:
            selectChannel = self.channelsInfos[2];
